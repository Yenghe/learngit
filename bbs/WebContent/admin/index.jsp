...
<html>
	...
	<body style="overflow-x: hidden; overflow-y: hidden; margin: 0px">
		...
		<table class=leftmenulist style="table-layout: fixed" height="100%" cellspacing=0
				...
				<tr class=leftmenutext>
					...
					<td>
						<iframe id=main	style="overflow: auto; height: 100%; width: 100%; z-index: 1; visibility: inherit"
							src="<%=path %>/admin/frame/adminmain.jsp" frameborder=0	name="main" scrolling=yes></iframe>
					</td>
				</tr>
			</tbody>
		</table>
